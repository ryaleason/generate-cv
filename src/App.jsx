...
function App() {
  ...
  // Keep phones in the responsive layout even when Chrome's "Desktop site"
  // changes the viewport width. Otherwise the 1100px desktop canvas shrinks
  // and overflows on a physical phone screen.
  const [viewMode, setViewMode] = useState(() => {
    ...
    return isPhone || window.matchMedia('(max-width: 1023px)').matches
      ? 'mobile'
      : 'desktop'
  })
